    ...
    public class TextureArrayBuilder : ScriptableObject {
        ...
        public void BuildTextureArray()
        {
            ...
            for (int i = 0; i < sourceTextures.Length; i++)
            {
                ...
                {
                    Debug.LogError($"Texture {sourceTextures[i].name} has different dimensions! All textures must be {width}x{height}");
                    return;
                }
            ...
            */
            ...
            Debug.Log($"Texture array created with {sourceTextures.Length} textures, {textureArray.mipmapCount} mip levels!");
        }
#endif
    }
}
